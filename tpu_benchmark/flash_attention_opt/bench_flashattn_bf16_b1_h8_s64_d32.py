"""
Benchmark: optimized FlashAttention bf16_b1_h8_s64_d32 vs PPL.

Fixed TL tile: `64 x 64`.
...
def tl_flashattn_opt():
    ...
    def main_kernel_inner(
        ...
        with T.Kernel(T.ceildiv(seq_len, block_M), batch, is_cpu=True) as (bx, bz):
            ...
            work0 = T.alloc_shared([heads, block_M, block_N], accum_dtype)
            work1 = T.alloc_shared([heads, block_M, block_N], accum_dtype)
...
def main():
    ...
    print("=" * 72)
    print(
        f"FlashAttention optimized bf16_b1_h8_s64_d32 B={BATCH} H={HEADS} S={SEQ_LEN} D={DIM} "
