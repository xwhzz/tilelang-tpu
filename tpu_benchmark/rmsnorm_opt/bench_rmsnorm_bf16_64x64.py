"""
Benchmark: optimized RMSNorm BF16 64x64 vs PPL.

Fixed TL variant: `keep_square_b32`.
...
M, N = 64, 64
BLK_M = 32
VARIANT = "keep_square_b32"
STRATEGY = "keep_square"
EPS = 1e-12
...
def main():
    ...
    print("=" * 72)
    print(f"RMSNorm BF16 optimized  M={M} N={N}  variant={VARIANT}  BLK_M={BLK_M}")
    print("=" * 72, flush=True)
