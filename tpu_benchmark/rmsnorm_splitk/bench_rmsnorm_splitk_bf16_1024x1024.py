"""
Benchmark: RMSNorm-SplitK BF16 1024x1024 — tilelang (splitk) vs PPL
...
def main():
    ...
    print("=" * 60)
    print(f"RMSNorm-SplitK BF16  M={M} N={N}  blk_m={BLK_M} blk_k={BLK_K}")
    print("=" * 60)
    ...
    try:
        ...
        pl_path = os.path.join(BENCH_DIR, "..", "rmsnorm", "pl", "rmsnorm_bf16_1024x1024.pl")
