...
Usage:
    ...
    python tpu_benchmark/swiglu/bench_swiglu_fp32_64x64.py
"""
...
def main():
    ...
    try:
        ...
        pl_path = os.path.join(BENCH_DIR, "pl", "swiglu_fp32_64x64.pl")
        arg_specs = [
            ((C, W), torch.float32),
            ((C, W), torch.float32),
            ((C, W), torch.float32),
    ...
    print("\n" + "=" * 60)
    print("Timing is printed by the C host framework above (look for 'execution time').")
    print("=" * 60)
