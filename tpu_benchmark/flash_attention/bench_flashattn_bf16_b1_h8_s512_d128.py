"""
FlashAttention BF16 B1H8S512D128 — tilelang vs PPL
...
def tl_flashattn_bf16_v2(batch, heads, seq_len, dim, block_M, block_N,
    ...
    def main_kernel_inner(
        ...
        with T.Kernel(T.ceildiv(seq_len, block_M), heads, batch, is_cpu=True) as (bx, by, bz):
            ...
            # Shared work/coeff/table — allocated once, reused every iteration
...
def main():
    ...
    try:
        ...
        pl_path = os.path.join(BENCH_DIR, "pl", "flashattn_bf16_b1_h8_s512_d128.pl")
