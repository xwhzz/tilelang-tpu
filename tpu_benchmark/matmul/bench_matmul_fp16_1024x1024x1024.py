"""
Benchmark: Matmul FP16 1024x1024x1024 — tilelang vs PPL
"""
...
def main():
    ...
    print("=" * 60)
    print(f"Matmul FP16  M={M} N={N} K={K}  block={BLOCK_M}x{BLOCK_N}x{BLOCK_K}")
    print("=" * 60)
    ...
    try:
        ...
        pl_path = os.path.join(BENCH_DIR, "pl", "matmul_fp16_1024x1024x1024.pl")
        arg_specs = [((M, K), torch.float16), ((K, N), torch.float16), ((M, N), torch.float16)]
