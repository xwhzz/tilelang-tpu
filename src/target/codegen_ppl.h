 ...
 */
#ifndef TVM_TL_TARGET_CODEGEN_PPL_H_
#define TVM_TL_TARGET_CODEGEN_PPL_H_
...
class CodeGenTileLangPPL final : public CodeGenC {
 ...
 private:
  ...
  friend void PrintConst(const FloatImmNode* op, std::ostream& os, CodeGenTileLangPPL* p);
