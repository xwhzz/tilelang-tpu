...
void main_kernel_inner(global_addr_t v1, global_addr_t v2, global_addr_t v3) {
  ...
  __ppl_tensor_info X_shared = {.shape = { 1, 128, 1, 128}, .stride = {0}, .addr = 131072, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info X_fp32 = {.shape = { 1, 128, 1, 128}, .stride = {0}, .addr = 65536, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 1024, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info X_pow2 = {.shape = { 1, 128, 1, 128}, .stride = {0}, .addr = 0, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 1024, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info X_powsum = {.shape = { 1, 128, 1, 1}, .stride = {0}, .addr = 180224, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 8, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info Weight_shared = {.shape = { 1, 1, 1, 128}, .stride = {0}, .addr = 196608, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 4, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info X = {.shape = {1, 128, 1, 128}, .stride = {16384, 128, 128, 1} , .addr = v4.addr + ((0) * 128+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((0) * 128+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
  __ppl_tensor_info X_shared_1 = {.shape = {1, 128, 1, 128}, .stride = {0}, .addr = X_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info X_shared_2 = {.shape = {1, 128, 1, 128}, .stride = {0}, .addr = X_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info X_fp32_1 = {.shape = {1, 128, 1, 128}, .stride = {0}, .addr = X_fp32.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info tmp_buffer_sum = {.shape = { 1, 128, 1, 32}, .stride = {0}, .addr = 163840, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 256, .unsigned_flag = 0, .default_stride = true};
  {
    int eu_num = 32;
    int align_w = 128;
    ...
    if (align_w > X_pow2.shape.w && align_w == eu_num) {
      dim4 padded_stride = {256, align_w, align_w, 1};
      ...
      if (align_w > X_pow2.shape.w) {
        ...
        dim4 fill_tensor_stride = {256, align_w, X_pow2.shape.w, 1};
  ...
  __ppl_tensor_info X_fp32_2 = {.shape = {1, 128, 1, 128}, .stride = {0}, .addr = X_fp32.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info X_shared_3 = {.shape = {1, 128, 1, 128}, .stride = {0}, .addr = X_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info X_shared_4 = {.shape = {1, 128, 1, 128}, .stride = {0}, .addr = X_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info Output = {.shape = {1, 128, 1, 128}, .stride = {16384, 128, 128, 1} , .addr = v6.addr + ((0) * 128+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((0) * 128+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
