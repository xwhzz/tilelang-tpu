...
void flashattn_inner(global_addr_t v1, global_addr_t v2, global_addr_t v3, global_addr_t v4) {
  ...
  __ppl_tensor_info v5 = {.shape = {1, 4, 2, 8}, .stride = NULL, .addr = v1, .dtype = DT_FP16, .mode = 2, .align_mode = 0, .size = 128, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info Q_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 245824, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info acc_o = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 229440, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info logsum = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 213056, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_max = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 196672, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info K_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 180288, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info acc_s = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 163904, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_max_prev = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 147712, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info tmp_buffer_max = {.shape = { 1, 2, 1, 32}, .stride = NULL, .addr = 147456, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 4, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_scale = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 131328, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work0 = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 122880, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work1 = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 106496, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info coeff = {.shape = { 1, 64, 1, 32}, .stride = NULL, .addr = 114688, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 128, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info table = {.shape = { 1, 64, 1, 192}, .stride = NULL, .addr = 49152, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 768, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work0_1 = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 245760, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work1_1 = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 229376, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info coeff_1 = {.shape = { 1, 64, 1, 32}, .stride = NULL, .addr = 98304, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 128, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info table_1 = {.shape = { 1, 64, 1, 192}, .stride = NULL, .addr = 0, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 768, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_sum = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 212992, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info tmp_buffer_sum = {.shape = { 1, 2, 1, 32}, .stride = NULL, .addr = 131072, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 4, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info acc_s_cast = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 196608, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info V_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 180224, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info O_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 163840, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  for (int bx = 0; bx < 2; ++bx) {
    for (int by = 0; by < 2; ++by) {
      __ppl_tensor_info Q = {.shape = {1, 2, 1, 8} , .stride = {64, 16, 8, 1} , .addr = v5.addr + ((0) * 64+((bx * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((0) * 64+((bx * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
      __ppl_tensor_info Q_shared_1 = {.shape = {1, 2, 1, 8}, .stride = NULL, .addr = Q_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
      ...
      for (int k = 0; k < 2; ++k) {
        __ppl_tensor_info K = {.shape = {1, 2, 1, 8} , .stride = {64, 16, 8, 1} , .addr = v6.addr + ((0) * 64+((k * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((0) * 64+((k * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
        __ppl_tensor_info K_shared_1 = {.shape = {1, 2, 1, 8}, .stride = NULL, .addr = K_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        ...
        tpu_bdc_fp_mm_R_trans(acc_s.addr, Q_shared.addr, K_shared.addr, 2, 8, 2, DT_FP32, DT_FP16);
        __ppl_tensor_info scores_max_1 = {.shape = {1, 2, 1, 1}, .stride = NULL, .addr = scores_max.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        __ppl_tensor_info scores_max_prev_1 = {.shape = {1, 2, 1, 1}, .stride = NULL, .addr = scores_max_prev.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        ...
        __ppl_tensor_info acc_s_1 = {.shape = {1, 2, 1, 2}, .stride = NULL, .addr = acc_s.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        __ppl_tensor_info acc_s_cast_1 = {.shape = {1, 2, 1, 2}, .stride = NULL, .addr = acc_s_cast.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        ...
        __ppl_tensor_info V = {.shape = {1, 2, 1, 8} , .stride = {64, 16, 8, 1} , .addr = v7.addr + ((0) * 64+((k * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((0) * 64+((k * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
        __ppl_tensor_info V_shared_1 = {.shape = {1, 2, 1, 8}, .stride = NULL, .addr = V_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        ...
        tpu_bdc_fp_mm(acc_o.addr, acc_s_cast.addr, V_shared.addr, 2, 2, 8, DT_FP32, DT_FP16, true);
      }
      dim4 logsum_stride;
      ...
      __ppl_tensor_info acc_o_1 = {.shape = {1, 2, 1, 8}, .stride = NULL, .addr = acc_o.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
      __ppl_tensor_info O_shared_1 = {.shape = {1, 2, 1, 8}, .stride = NULL, .addr = O_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
      ...
      __ppl_tensor_info O_shared_2 = {.shape = {1, 2, 1, 8}, .stride = NULL, .addr = O_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
      __ppl_tensor_info Output = {.shape = {1, 2, 1, 8} , .stride = {64, 16, 8, 1} , .addr = v8.addr + ((0) * 64+((bx * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((0) * 64+((bx * 2)) * 16+(by) * 8+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
