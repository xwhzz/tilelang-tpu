...
void main(global_addr_t v1, global_addr_t v2, global_addr_t v3, global_addr_t v4) {
  ...
  __ppl_tensor_info Q_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 163840, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info acc_o = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 98304, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info logsum = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 81920, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_max = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 65536, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info K_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 147456, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info acc_s = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 49152, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_max_prev = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 32768, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info tmp_buffer_max = {.shape = { 1, 2, 1, 32}, .stride = NULL, .addr = 81920, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 4, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_scale = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 16384, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work0 = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 0, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work1 = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 245760, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info table = {.shape = { 1, 64, 1, 192}, .stride = NULL, .addr = 16384, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 768, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work0_1 = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 229376, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work1_1 = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 212992, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info coeff_1 = {.shape = { 1, 64, 1, 32}, .stride = NULL, .addr = 32768, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 128, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info scores_sum = {.shape = { 1, 2, 1, 1}, .stride = NULL, .addr = 196608, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info tmp_buffer_sum = {.shape = { 1, 2, 1, 32}, .stride = NULL, .addr = 65536, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 4, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info acc_s_cast = {.shape = { 1, 2, 1, 2}, .stride = NULL, .addr = 180224, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info V_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 131072, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info O_shared = {.shape = { 1, 2, 1, 8}, .stride = NULL, .addr = 114688, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
