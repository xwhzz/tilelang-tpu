...
void llama_mlp_forward(global_addr_t v1, global_addr_t v2, global_addr_t v3, global_addr_t v4, global_addr_t v5, global_addr_t v6, global_addr_t v7, global_addr_t v8, global_addr_t v9, global_addr_t v10, global_addr_t v11) {
  __ppl_tensor_info v21 = {.shape = {1 ,32, 1, 32}, .stride = {0}, .addr = v10, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 2048, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v15 = {.shape = {1 ,32, 1, 32}, .stride = {0}, .addr = v4, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 2048, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v14 = {.shape = {1 ,32, 1, 32}, .stride = {0}, .addr = v3, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 2048, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v13 = {.shape = {1 ,32, 1, 32}, .stride = {0}, .addr = v2, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 2048, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v12 = {.shape = {1 ,32, 1, 32}, .stride = {0}, .addr = v1, .dtype = DT_BFP16, .mode = 2, .align_mode = 0, .size = 2048, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info down_out_acc = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 245760, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&down_out_acc.stride, 0, &down_out_acc.shape, DT_FP32);
  __ppl_tensor_info down_out_block = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 135168, .dtype = DT_BFP16, .mode = 2, .align_mode = 1, .size = 32, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&down_out_block.stride, 0, &down_out_block.shape, DT_BFP16);
  __ppl_tensor_info ones = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 229376, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  ...
  __ppl_tensor_info down_weight_block = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 118784, .dtype = DT_BFP16, .mode = 2, .align_mode = 1, .size = 32, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&down_weight_block.stride, 0, &down_weight_block.shape, DT_BFP16);
  __ppl_tensor_info gated_up_block = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 102400, .dtype = DT_BFP16, .mode = 2, .align_mode = 1, .size = 32, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&gated_up_block.stride, 0, &gated_up_block.shape, DT_BFP16);
  __ppl_tensor_info down_out_part_fp32 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 212992, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&down_out_part_fp32.stride, 0, &down_out_part_fp32.shape, DT_FP32);
  __ppl_tensor_info gate_out_block_fp32 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 196608, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&gate_out_block_fp32.stride, 0, &gate_out_block_fp32.shape, DT_FP32);
  __ppl_tensor_info up_out_block_fp32 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 180224, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&up_out_block_fp32.stride, 0, &up_out_block_fp32.shape, DT_FP32);
  __ppl_tensor_info silu_out_block = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 163840, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&silu_out_block.stride, 0, &silu_out_block.shape, DT_FP32);
  __ppl_tensor_info gated_up_fp32 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 147456, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&gated_up_fp32.stride, 0, &gated_up_fp32.shape, DT_FP32);
  __ppl_tensor_info x_neg = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 131072, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&x_neg.stride, 0, &x_neg.shape, DT_FP32);
  __ppl_tensor_info x_neg_exp_1 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 114688, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&x_neg_exp_1.stride, 0, &x_neg_exp_1.shape, DT_FP32);
  __ppl_tensor_info exp_work0 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 98304, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&exp_work0.stride, 0, &exp_work0.shape, DT_FP32);
  __ppl_tensor_info exp_work1 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 81920, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  ...
  __ppl_tensor_info x_block = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 86016, .dtype = DT_BFP16, .mode = 2, .align_mode = 1, .size = 32, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&x_block.stride, 0, &x_block.shape, DT_BFP16);
  __ppl_tensor_info gate_weight_block = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 69632, .dtype = DT_BFP16, .mode = 2, .align_mode = 1, .size = 32, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&gate_weight_block.stride, 0, &gate_weight_block.shape, DT_BFP16);
  __ppl_tensor_info up_weight_block = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 57344, .dtype = DT_BFP16, .mode = 2, .align_mode = 1, .size = 32, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&up_weight_block.stride, 0, &up_weight_block.shape, DT_BFP16);
  __ppl_tensor_info proj_part_fp32 = {.shape = { 1, 32, 1, 32}, .stride = {0}, .addr = 65536, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 64, .unsigned_flag = 0, .default_stride = false};
  tpu_aligned_stride(&proj_part_fp32.stride, 0, &proj_part_fp32.shape, DT_FP32);
  __ppl_tensor_info x = {.shape = {1, 32, 1, 32}, .stride = {1024, 32, 32, 1} , .addr = v12.addr + ((0) * 32+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
  __ppl_tensor_info x_block_1 = {.shape = {1, 32, 1, 32}, .stride = x_block.stride, .addr = x_block.addr, .dtype = DT_BFP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = x_block.default_stride};
  ...
  __ppl_tensor_info gate_weight = {.shape = {1, 32, 1, 32}, .stride = {1024, 32, 32, 1} , .addr = v14.addr + ((0) * 32+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
  __ppl_tensor_info gate_weight_block_1 = {.shape = {1, 32, 1, 32}, .stride = gate_weight_block.stride, .addr = gate_weight_block.addr, .dtype = DT_BFP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = gate_weight_block.default_stride};
  ...
  __ppl_tensor_info up_weight = {.shape = {1, 32, 1, 32}, .stride = {1024, 32, 32, 1} , .addr = v13.addr + ((0) * 32+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
  __ppl_tensor_info up_weight_block_1 = {.shape = {1, 32, 1, 32}, .stride = up_weight_block.stride, .addr = up_weight_block.addr, .dtype = DT_BFP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = up_weight_block.default_stride};
  ...
  tpu_bdc_fp_mm_R_trans(proj_part_fp32.addr, x_block.addr, gate_weight_block.addr, 32, 32, 32, DT_FP32, DT_BFP16);
  ...
  tpu_bdc_fp_mm_R_trans(proj_part_fp32.addr, x_block.addr, up_weight_block.addr, 32, 32, 32, DT_FP32, DT_BFP16);
  ...
  __ppl_tensor_info gated_up_fp32_1 = {.shape = {1, 32, 1, 32}, .stride = gated_up_fp32.stride, .addr = gated_up_fp32.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = gated_up_fp32.default_stride};
  __ppl_tensor_info gated_up_block_1 = {.shape = {1, 32, 1, 32}, .stride = gated_up_block.stride, .addr = gated_up_block.addr, .dtype = DT_BFP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = gated_up_block.default_stride};
  ...
  __ppl_tensor_info down_weight = {.shape = {1, 32, 1, 32}, .stride = {1024, 32, 32, 1} , .addr = v15.addr + ((0) * 32+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
  __ppl_tensor_info down_weight_block_1 = {.shape = {1, 32, 1, 32}, .stride = down_weight_block.stride, .addr = down_weight_block.addr, .dtype = DT_BFP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = down_weight_block.default_stride};
  ...
  tpu_bdc_fp_mm_R_trans(down_out_part_fp32.addr, gated_up_block.addr, down_weight_block.addr, 32, 32, 32, DT_FP32, DT_BFP16);
  ...
  __ppl_tensor_info down_out_acc_1 = {.shape = {1, 32, 1, 32}, .stride = down_out_acc.stride, .addr = down_out_acc.addr, .dtype = DT_FP32, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = down_out_acc.default_stride};
  __ppl_tensor_info down_out_block_1 = {.shape = {1, 32, 1, 32}, .stride = down_out_block.stride, .addr = down_out_block.addr, .dtype = DT_BFP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = down_out_block.default_stride};
  ...
  __ppl_tensor_info down_out_block_2 = {.shape = {1, 32, 1, 32}, .stride = down_out_block.stride, .addr = down_out_block.addr, .dtype = DT_BFP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = down_out_block.default_stride};
  __ppl_tensor_info output = {.shape = {1, 32, 1, 32}, .stride = {1024, 32, 32, 1} , .addr = v21.addr + ((0) * 32+(0) * 1 ) * 2, .dtype = DT_BFP16, .mode = 2, .size = 1, .offset = ((0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
