...
void mm2_fp16_inner(global_addr_t v1, global_addr_t v2, global_addr_t v3) {
  ...
  __ppl_tensor_info A_shared_0 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 196608, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info B_shared_0 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 163840, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info A_shared_1 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 131072, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info B_shared_1 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 98304, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info C_shared = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 65536, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
