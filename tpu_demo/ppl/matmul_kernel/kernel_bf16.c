  ...
  for (int bx = 0; bx < 6; ++bx) {
    for (int by = 0; by < 3; ++by) {
      ...
      for (int k = 0; k < 5; ++k) {
        ...
        tpu_bdc_fp_mm(C_shared.addr, A_shared_5.addr, B_shared_5.addr, 128, 128, 128, DT_FP32, DT_BFP16, true);
        tpu_parallel_end(); 
      }
      tpu_bdc_fp_mm(C_shared.addr, A_shared_1.addr, B_shared_1.addr, 128, 128, 128, DT_FP32, DT_BFP16, true);
