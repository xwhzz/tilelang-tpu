...
void main(global_addr_t v1, global_addr_t v2, global_addr_t v3) {
  __ppl_tensor_info v5 = {.shape = {1 ,786, 1, 786}, .stride = NULL, .addr = v2, .dtype = DT_FP16, .mode = 2, .align_mode = 0, .size = 1235592, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info v6 = {.shape = {1 ,384, 1, 786}, .stride = NULL, .addr = v3, .dtype = DT_FP32, .mode = 2, .align_mode = 0, .size = 1207296, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info v4 = {.shape = {1 ,384, 1, 786}, .stride = NULL, .addr = v1, .dtype = DT_FP16, .mode = 2, .align_mode = 0, .size = 603648, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info A_shared_0 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 65536, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info B_shared_0 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 49152, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info A_shared_1 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 32768, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info B_shared_1 = {.shape = { 1, 128, 1, 128}, .stride = NULL, .addr = 16384, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 512, .unsigned_flag = 0, .default_stride = true};
  for (int bx = 0; bx < 7; ++bx) {
    for (int by = 0; by < 3; ++by) {
      ...
      __ppl_tensor_info A = {.shape = {1, 128, 1, 128}, .stride = {301824, 786, 786, 1} , .addr = v4.addr + (((by * 128)) * 786+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = (((by * 128)) * 786+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
      ...
      __ppl_tensor_info B = {.shape = {1, 128, 1, 128}, .stride = {617796, 786, 786, 1} , .addr = v5.addr + ((0) * 786+((bx * 128)) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((0) * 786+((bx * 128)) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
      ...
      for (int k = 0; k < 6; ++k) {
        ...
        __ppl_tensor_info A_1 = {.shape = {1, 128, 1, 128}, .stride = {301824, 786, 786, 1} , .addr = v4.addr + (((by * 128)) * 786+(((k * 128) + 128)) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = (((by * 128)) * 786+(((k * 128) + 128)) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
        ...
        __ppl_tensor_info B_1 = {.shape = {1, 128, 1, 128}, .stride = {617796, 786, 786, 1} , .addr = v5.addr + ((((k * 128) + 128)) * 786+((bx * 128)) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((((k * 128) + 128)) * 786+((bx * 128)) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
      ...
      tpu_bdc_fp_mm(C_shared.addr, A_shared_0.addr, B_shared_0.addr,128, 128, 128, DT_FP32, DT_FP16, true);
      ...
      __ppl_tensor_info C = {.shape = {1, 128, 1, 128}, .stride = {301824, 786, 786, 1} , .addr = v6.addr + (((by * 128)) * 786+((bx * 128)) * 1 ) * 4, .dtype = DT_FP32, .mode = 2, .size = 1, .offset = (((by * 128)) * 786+((bx * 128)) * 1 ) * 4, .unsigned_flag = 0, .default_stride = false};
