...
def embedding_test(select_num, inner_num, index_num, dtype_0="float32", dtype_1 = 'uint16'):
    @T.prim_func
    def main(
        ...
        if dtype_0 == "float16":
            T.ppl_fill(output_shared, T.float16(float(0.0)))
        else:
...
func = embedding_test(65, 17, 7, "float32")
