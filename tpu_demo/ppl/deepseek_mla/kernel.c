...
void flashattn_inner(global_addr_t v1, global_addr_t v2, global_addr_t v3, global_addr_t v4, global_addr_t v5) {
  ...
  __ppl_tensor_info v10 = {.shape = {4, 8, 1, 32}, .stride = NULL, .addr = v5, .dtype = DT_FP16, .mode = 2, .align_mode = 0, .size = 2048, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info v7 = {.shape = {4, 8, 1, 4}, .stride = NULL, .addr = v2, .dtype = DT_FP16, .mode = 2, .align_mode = 0, .size = 256, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info v6 = {.shape = {4, 8, 1, 32}, .stride = NULL, .addr = v1, .dtype = DT_FP16, .mode = 2, .align_mode = 0, .size = 2048, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info Q_shared = {.shape = { 1, 4, 1, 32}, .stride = NULL, .addr = 147456, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 4, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info Q_pe_shared = {.shape = { 1, 4, 1, 4}, .stride = NULL, .addr = 213056, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info logsum = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 196672, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_max = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 180288, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info KV_shared = {.shape = { 1, 4, 1, 32}, .stride = NULL, .addr = 131072, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 4, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info K_pe_shared = {.shape = { 1, 4, 1, 4}, .stride = NULL, .addr = 163904, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info acc_s_pe = {.shape = { 1, 4, 1, 4}, .stride = NULL, .addr = 131328, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_max_prev = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 114944, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info prev_scaled = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 98816, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info curr_scaled = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 82432, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_scale = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 66048, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work0 = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 57344, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work1 = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 245760, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info scores_scaled = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 229376, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work0_1 = {.shape = { 1, 4, 1, 4}, .stride = NULL, .addr = 212992, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info work1_1 = {.shape = { 1, 4, 1, 4}, .stride = NULL, .addr = 196608, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  __ppl_tensor_info scores_sum = {.shape = { 1, 4, 1, 1}, .stride = NULL, .addr = 180224, .dtype = DT_FP32, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  __ppl_tensor_info S_shared = {.shape = { 1, 4, 1, 4}, .stride = NULL, .addr = 163840, .dtype = DT_FP16, .mode = 2, .align_mode = 1, .size = 0, .unsigned_flag = 0, .default_stride = true};
  ...
  for (int bx = 0; bx < 4; ++bx) {
    for (int by = 0; by < 2; ++by) {
      __ppl_tensor_info Q = {.shape = {1, 4, 1, 32} , .stride = {256, 32, 32, 1} , .addr = v6.addr + ((bx) * 256+((by * 4)) * 32+(0) * 32+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((bx) * 256+((by * 4)) * 32+(0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
      ...
      __ppl_tensor_info Q_pe = {.shape = {1, 4, 1, 4} , .stride = {32, 4, 4, 1} , .addr = v7.addr + ((bx) * 32+((by * 4)) * 4+(0) * 4+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((bx) * 32+((by * 4)) * 4+(0) * 4+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
      ...
      for (int k = 0; k < 128; ++k) {
        __ppl_tensor_info KV = {.shape = {1, 4, 1, 32} , .stride = {16384, 32, 32, 1} , .addr = v8.addr + ((bx) * 16384+((k * 4)) * 32+(0) * 32+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((bx) * 16384+((k * 4)) * 32+(0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
        __ppl_tensor_info KV_shared_1 = {.shape = {1, 4, 1, 32}, .stride = NULL, .addr = KV_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        tpu_gdma_cpy_S2L(KV_shared_1.addr, KV.addr, &KV_shared_1.shape, (KV_shared_1.default_stride ? NULL : &KV_shared_1.stride), (KV.default_stride ? NULL : &KV.stride), DT_FP16);
        __ppl_tensor_info K_pe = {.shape = {1, 4, 1, 4} , .stride = {2048, 4, 4, 1} , .addr = v9.addr + ((bx) * 2048+((k * 4)) * 4+(0) * 4+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((bx) * 2048+((k * 4)) * 4+(0) * 4+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
        __ppl_tensor_info K_pe_shared_1 = {.shape = {1, 4, 1, 4}, .stride = NULL, .addr = K_pe_shared.addr, .dtype = DT_FP16, .mode = 0, .size = 1, .offset = 0, .unsigned_flag = 0, .default_stride = true};
        tpu_gdma_cpy_S2L(K_pe_shared_1.addr, K_pe.addr, &K_pe_shared_1.shape, (K_pe_shared_1.default_stride ? NULL : &K_pe_shared_1.stride), (K_pe.default_stride ? NULL : &K_pe.stride), DT_FP16);
        {
        ...
        tpu_bdc_fp_mm_R_trans(acc_s.addr, Q_shared.addr, KV_shared.addr, 4, 32, 4, DT_FP32, DT_FP16);
        {
        scalar_t acc_s_pe_scalar_f32 = {.f32 = 0};
        tpu_bdc_set_C(acc_s_pe.addr, acc_s_pe_scalar_f32, &acc_s_pe.shape, (acc_s_pe.default_stride ? NULL : &acc_s_pe.stride), DT_FP32);
        }
        tpu_bdc_fp_mm_R_trans(acc_s_pe.addr, Q_pe_shared.addr, K_pe_shared.addr, 4, 4, 4, DT_FP32, DT_FP16);
        {
          tpu_bdc_fp_add( acc_s.addr, acc_s.addr, acc_s_pe.addr, &acc_s.shape, (acc_s.default_stride ? NULL : &acc_s.stride), (acc_s.default_stride ? NULL : &acc_s.stride), (acc_s_pe.default_stride ? NULL : &acc_s_pe.stride), DT_FP32);
        }
        ...
        tpu_bdc_fp_mm(acc_o.addr, S_shared.addr, KV_shared.addr, 4, 4, 32, DT_FP32, DT_FP16, true);
      }
      {
        dim4 logsum_stride;
      ...
      __ppl_tensor_info Output = {.shape = {1, 4, 1, 32} , .stride = {256, 32, 32, 1} , .addr = v10.addr + ((bx) * 256+((by * 4)) * 32+(0) * 32+(0) * 1 ) * 2, .dtype = DT_FP16, .mode = 2, .size = 1, .offset = ((bx) * 256+((by * 4)) * 32+(0) * 32+(0) * 1 ) * 2, .unsigned_flag = 0, .default_stride = false};
